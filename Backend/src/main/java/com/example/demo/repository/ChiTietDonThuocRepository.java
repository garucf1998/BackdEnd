...
public interface ChiTietDonThuocRepository extends JpaRepository<ChiTietDonThuoc,Long> {
    ...
    @Query(value = "select * from chi_tiet_don_thuoc join phieu_khambenh on chi_tiet_don_thuoc.donthuoc_id=phieu_khambenh.donthuoc_id where phieu_khambenh.benhnhan_id like ?1",nativeQuery = true)
